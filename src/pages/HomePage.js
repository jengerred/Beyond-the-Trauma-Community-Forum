  ...
  return (
    ...
    <div style={{height: "10rem"}}>
      <p style={{margin: "1rem"}}>
        ...
        Your safety is our top priority, which is why our registration process is <b>secure</b> and <b>anonymous</b>. We have implemented a passwordless system using passkeys that require a fingerprint, face scan, or a personal identification number (PIN). To get started, enter an e-mail address and setup a passkey.
      </p>
    </div>
